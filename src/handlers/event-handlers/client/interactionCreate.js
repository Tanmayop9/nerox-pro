import { createContext } from '../../core/utilities/contextFrom/interaction.js';
        ...
        if (interaction.isButton()) {
            ...
            if (interaction.customId === 'create_ticket') {
                ...
                const existing = interaction.guild.channels.cache.find(
                    ch =>
                        ch.name === `ticket-${interaction.user.username.toLowerCase().replace(/[^a-z0-9]/gi, '')}` &&
                ...
                const embed = client.embed()
                    ...
                    .desc(`Welcome ${interaction.user}, our team will assist you shortly.`)
                    .footer({ text: 'Use the close command or button when your issue is resolved.' });
