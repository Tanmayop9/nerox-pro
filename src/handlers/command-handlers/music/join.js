            ...
            if (!player || !ctx.guild.members.me?.voice.channelId) {
                ...
                await ctx.reply({
                    embeds: [
                        client
                            .embed()
                            .desc(`${client.emoji.check} Joined ${ctx.member.voice.channel} and bound to ${ctx.channel}.`),
                    ],
                });
                return;
            }
            ...
            collector.on('collect', async (interaction) => {
                ...
                await reply.edit({
                    embeds: [
                        client
                            .embed()
                            .desc(`${client.emoji.check} Moved to ${ctx.member.voice.channel} and bound to ${ctx.channel}.`),
                    ],
                    components: [],
                });
